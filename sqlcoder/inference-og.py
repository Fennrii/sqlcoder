...
def generate_prompt(question, prompt_file="/root/sqlcoder/prompt.md", metadata_file="/root/sqlcoder/metadata.sql"):
...
def run_inference(question, prompt_file="/root/sqlcoder/prompt.md", metadata_file="/root/sqlcoder/metadata.sql"):
